        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <StyledBox>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button 
                type="submit" 
                className="group relative w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium rounded-lg transition-all duration-300 flex justify-center items-center overflow-hidden hover:scale-105 hover:shadow-lg hover:shadow-blue-500/50"
